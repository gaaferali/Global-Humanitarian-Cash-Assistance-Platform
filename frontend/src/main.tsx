...
const arabicInline: Record<string, string> = {
  ...
  "Save": "حفظ", "Create": "إنشاء", "Delete": "حذف", "Edit": "تعديل", "Update": "تحديث", "View": "عرض", "Search": "بحث", "Assign": "تعيين", "Resolve": "حل", "Submit": "إرسال", "Close": "إغلاق", "Back": "رجوع", "Continue": "متابعة", "Cancel": "إلغاء", "Confirm": "تأكيد", "Yes": "نعم", "No": "لا",
